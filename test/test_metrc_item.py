...
class TestMetrcItem(unittest.TestCase):
    """MetrcItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcItem:
        """Test MetrcItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcItem`
        """
        model = MetrcItem()
        if include_optional:
            return MetrcItem(
