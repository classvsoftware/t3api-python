...
class TestV2SalesTransactionsGet200Response(unittest.TestCase):
    """V2SalesTransactionsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2SalesTransactionsGet200Response:
        """Test V2SalesTransactionsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2SalesTransactionsGet200Response`
        """
        model = V2SalesTransactionsGet200Response()
        if include_optional:
            return V2SalesTransactionsGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_transaction.MetrcTransaction(
                        id = 123467, 
                        ...
                        package_id = 123466, 
                        trip_id = 56, 
                        trip_manifest_number = '', 
                        package_label = '1A4000000000000000000023', 
                        is_partial = True, 
                        has_partial = False, 
                        package_type = 'Product', 
                        product_name = ' Pre-Roll - (2pk) 0.5g - Gelato', 
                        product_category_name = 'Raw Preroll (Final Packaging)', 
                        item_strain_name = '', 
                        item_brand_name = '', 
                        ...
                        item_unit_weight = 1.0, 
                        item_unit_weight_unit_of_measure_abbreviation = 'g', 
                        item_serving_size = '0.5 grams', 
                        item_supply_duration_days = 56, 
                        item_unit_quantity = 1.337, 
                        item_unit_quantity_unit_of_measure_abbreviation = '', 
                        quantity_sold = 1.0, 
                        unit_of_measure_id = 1, 
                        unit_of_measure_name = 'Each', 
                        unit_of_measure_abbreviation = 'ea', 
                        unit_thc_percent = 1.337, 
                        unit_thc_content = 1.337, 
                        unit_thc_content_unit_of_measure_id = 56, 
                        unit_weight = 1.0, 
                        unit_weight_unit_of_measure_id = 4, 
                        total_price = 0.01, 
                        sales_delivery_state = '', 
                        sales_delivery_state_name = '', 
                        ...
                        recorded_date_time = '0001-01-01T00:00Z', 
                        recorded_by_user_name = '', 
                        last_modified = '2024-09-06T20:00Z', 
                        invoice_number = '', 
                        price = 1.337, 
                        excise_tax = 1.337, 
                        city_tax = 1.337, 
    ...
    def testV2SalesTransactionsGet200Response(self):
        """Test V2SalesTransactionsGet200Response"""
