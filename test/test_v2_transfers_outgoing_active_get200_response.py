...
class TestV2TransfersOutgoingActiveGet200Response(unittest.TestCase):
    """V2TransfersOutgoingActiveGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersOutgoingActiveGet200Response:
        """Test V2TransfersOutgoingActiveGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersOutgoingActiveGet200Response`
        """
        model = V2TransfersOutgoingActiveGet200Response()
        if include_optional:
            return V2TransfersOutgoingActiveGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_outgoing_transfer.MetrcOutgoingTransfer(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        index = 'ACTIVE_OUTGOING_TRANSFER', 
                        id = 1234567, 
                        manifest_number = '0001234567', 
                        shipment_license_type_name = 'Licensed', 
                        shipper_facility_license_number = 'LIC-00002', 
                        shipper_facility_name = 'Fire Manufacturing, Inc.', 
                        name = '', 
                        ...
                        delivery_facilities = 'LIC-00001 (Dank Dispensary LLC)', 
                        delivery_count = 1, 
                        received_delivery_count = 0, 
                        package_count = 8, 
                        received_package_count = 0, 
                        contains_plant_package = False, 
                        contains_product_package = True, 
                        ...
                        edit_count = 1, 
                        can_edit = True, 
                        can_edit_outgoing_inactive = False, 
                        is_voided = False, 
                        created_date_time = '2024-07-25T13:00Z', 
                        created_by_user_name = 'Mike Smith', 
                        last_modified = '2024-07-25T00:00Z', 
                        delivery_id = 1234566, 
                        recipient_facility_id = 456, 
                        recipient_facility_license_number = 'LIC-00001', 
                        recipient_facility_name = 'Dank Dispensary LLC', 
                        shipment_type_name = 'Unaffiliated Transfer', 
                        shipment_transaction_type_name = 'Wholesale', 
                        estimated_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        actual_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        estimated_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        actual_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery_package_count = 8, 
                        delivery_received_package_count = 0, 
                        received_by_name = '', 
                        received_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        estimated_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        actual_return_departure_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        estimated_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        actual_return_arrival_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        rejected_packages_returned = False, 
                        transporter_all_approval_date = '2024-07-25T13:00Z', 
                        destinations_all_approval_date = '2024-07-25T13:00Z', 
                        transporters_automatically_approved = True, 
                        destinations_automatically_approved = True, 
                        approval_reject_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
    ...
    def testV2TransfersOutgoingActiveGet200Response(self):
        """Test V2TransfersOutgoingActiveGet200Response"""
