...
class TestMetrcHarvestReportResponse(unittest.TestCase):
    """MetrcHarvestReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvestReportResponse:
        """Test MetrcHarvestReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvestReportResponse`
        """
        model = MetrcHarvestReportResponse()
        if include_optional:
            return MetrcHarvestReportResponse(
    ...
    def testMetrcHarvestReportResponse(self):
        """Test MetrcHarvestReportResponse"""
