...
class TestMetrcStrain(unittest.TestCase):
    """MetrcStrain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcStrain:
        """Test MetrcStrain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcStrain`
        """
        model = MetrcStrain()
        if include_optional:
            return MetrcStrain(
