...
class TestV2PackagesActiveReportGet200Response(unittest.TestCase):
    """V2PackagesActiveReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesActiveReportGet200Response:
        """Test V2PackagesActiveReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesActiveReportGet200Response`
        """
        model = V2PackagesActiveReportGet200Response()
        if include_optional:
            return V2PackagesActiveReportGet200Response(
                ...
                data = [
                    t3api.models.metrc_package.MetrcPackage(
                        id = 1234567, 
    ...
    def testV2PackagesActiveReportGet200Response(self):
        """Test V2PackagesActiveReportGet200Response"""
