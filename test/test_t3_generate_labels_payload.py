...
class TestT3GenerateLabelsPayload(unittest.TestCase):
    """T3GenerateLabelsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3GenerateLabelsPayload:
        """Test T3GenerateLabelsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3GenerateLabelsPayload`
        """
    ...
    def testT3GenerateLabelsPayload(self):
        """Test T3GenerateLabelsPayload"""
