...
class TestMetrcPlant(unittest.TestCase):
    """MetrcPlant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPlant:
        """Test MetrcPlant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPlant`
        """
        model = MetrcPlant()
        if include_optional:
            return MetrcPlant(
