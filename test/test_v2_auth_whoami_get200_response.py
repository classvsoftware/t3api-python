...
class TestV2AuthWhoamiGet200Response(unittest.TestCase):
    """V2AuthWhoamiGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AuthWhoamiGet200Response:
        """Test V2AuthWhoamiGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AuthWhoamiGet200Response`
        """
        model = V2AuthWhoamiGet200Response()
        if include_optional:
            return V2AuthWhoamiGet200Response(
    ...
    def testV2AuthWhoamiGet200Response(self):
        """Test V2AuthWhoamiGet200Response"""
