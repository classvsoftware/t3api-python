...
class TestMetrcIncomingTransfer(unittest.TestCase):
    """MetrcIncomingTransfer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcIncomingTransfer:
        """Test MetrcIncomingTransfer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcIncomingTransfer`
        """
        model = MetrcIncomingTransfer()
        if include_optional:
            return MetrcIncomingTransfer(
    ...
    def testMetrcIncomingTransfer(self):
        """Test MetrcIncomingTransfer"""
