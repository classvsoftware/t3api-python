...
class TestMetrcFacility(unittest.TestCase):
    """MetrcFacility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcFacility:
        """Test MetrcFacility
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcFacility`
        """
        model = MetrcFacility()
        if include_optional:
            return MetrcFacility(
