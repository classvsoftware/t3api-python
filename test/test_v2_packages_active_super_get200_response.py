...
class TestV2PackagesActiveSuperGet200Response(unittest.TestCase):
    """V2PackagesActiveSuperGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesActiveSuperGet200Response:
        """Test V2PackagesActiveSuperGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesActiveSuperGet200Response`
        """
        model = V2PackagesActiveSuperGet200Response()
        if include_optional:
            return V2PackagesActiveSuperGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2PackagesActiveSuperGet200Response(self):
        """Test V2PackagesActiveSuperGet200Response"""
