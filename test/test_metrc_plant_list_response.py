...
class TestMetrcPlantListResponse(unittest.TestCase):
    """MetrcPlantListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPlantListResponse:
        """Test MetrcPlantListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPlantListResponse`
        """
        model = MetrcPlantListResponse()
        if include_optional:
            return MetrcPlantListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcPlantListResponse(self):
        """Test MetrcPlantListResponse"""
