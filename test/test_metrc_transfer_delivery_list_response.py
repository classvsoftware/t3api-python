...
class TestMetrcTransferDeliveryListResponse(unittest.TestCase):
    """MetrcTransferDeliveryListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferDeliveryListResponse:
        """Test MetrcTransferDeliveryListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferDeliveryListResponse`
        """
        model = MetrcTransferDeliveryListResponse()
        if include_optional:
            return MetrcTransferDeliveryListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcTransferDeliveryListResponse(self):
        """Test MetrcTransferDeliveryListResponse"""
