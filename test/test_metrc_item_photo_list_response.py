...
class TestMetrcItemPhotoListResponse(unittest.TestCase):
    """MetrcItemPhotoListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcItemPhotoListResponse:
        """Test MetrcItemPhotoListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcItemPhotoListResponse`
        """
        model = MetrcItemPhotoListResponse()
        if include_optional:
            return MetrcItemPhotoListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcItemPhotoListResponse(self):
        """Test MetrcItemPhotoListResponse"""
