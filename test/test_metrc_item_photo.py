...
class TestMetrcItemPhoto(unittest.TestCase):
    """MetrcItemPhoto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcItemPhoto:
        """Test MetrcItemPhoto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcItemPhoto`
        """
        model = MetrcItemPhoto()
        if include_optional:
            return MetrcItemPhoto(
