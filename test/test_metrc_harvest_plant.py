...
class TestMetrcHarvestPlant(unittest.TestCase):
    """MetrcHarvestPlant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvestPlant:
        """Test MetrcHarvestPlant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvestPlant`
        """
        model = MetrcHarvestPlant()
        if include_optional:
            return MetrcHarvestPlant(
    ...
    def testMetrcHarvestPlant(self):
        """Test MetrcHarvestPlant"""
