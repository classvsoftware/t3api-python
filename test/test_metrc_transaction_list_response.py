...
class TestMetrcTransactionListResponse(unittest.TestCase):
    """MetrcTransactionListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransactionListResponse:
        """Test MetrcTransactionListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransactionListResponse`
        """
        model = MetrcTransactionListResponse()
        if include_optional:
            return MetrcTransactionListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcTransactionListResponse(self):
        """Test MetrcTransactionListResponse"""
