...
class TestTransfersApi(unittest.TestCase):
    ...
    def test_v2_transfers_create_inputs_get(self) -> None:
        """Test case for v2_transfers_create_inputs_get
    ...
    def test_v2_transfers_deliveries_get(self) -> None:
        """Test case for v2_transfers_deliveries_get

        List of deliveries for a single transfer
        """
        pass

    def test_v2_transfers_history_get(self) -> None:
        """Test case for v2_transfers_history_get

        List of transfer history objects for a single transfer
        """
        pass

    def test_v2_transfers_incoming_active_get(self) -> None:
        """Test case for v2_transfers_incoming_active_get

        List of incoming active transfers
        """
        pass

    def test_v2_transfers_incoming_inactive_get(self) -> None:
        """Test case for v2_transfers_incoming_inactive_get
    ...
    def test_v2_transfers_manifest_get(self) -> None:
        """Test case for v2_transfers_manifest_get

        Get the manifest PDF for a transfer.
        """
        pass

    def test_v2_transfers_outgoing_active_get(self) -> None:
        """Test case for v2_transfers_outgoing_active_get

        List of outgoing active transfers
        """
        pass

    def test_v2_transfers_outgoing_inactive_get(self) -> None:
        """Test case for v2_transfers_outgoing_inactive_get

        List of outgoing inactive transfers
        """
        pass

    def test_v2_transfers_outgoing_manifest_report_get(self) -> None:
        """Test case for v2_transfers_outgoing_manifest_report_get

        Generate a report of all outgoing transfer manifests
        """
        pass

    def test_v2_transfers_packages_get(self) -> None:
        """Test case for v2_transfers_packages_get

        List of packages for a single delivery
        """
        pass

    def test_v2_transfers_rejected_get(self) -> None:
    ...
    def test_v2_transfers_transporter_details_get(self) -> None:
        """Test case for v2_transfers_transporter_details_get

        List of transporter detailss for a single transfer
        """
        pass

    def test_v2_transfers_transporters_get(self) -> None:
        """Test case for v2_transfers_transporters_get
