...
class TestMetrcIncomingTransferListResponse(unittest.TestCase):
    """MetrcIncomingTransferListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcIncomingTransferListResponse:
        """Test MetrcIncomingTransferListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcIncomingTransferListResponse`
        """
        model = MetrcIncomingTransferListResponse()
        if include_optional:
            return MetrcIncomingTransferListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcIncomingTransferListResponse(self):
        """Test MetrcIncomingTransferListResponse"""
