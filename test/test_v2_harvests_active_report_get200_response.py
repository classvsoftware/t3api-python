...
class TestV2HarvestsActiveReportGet200Response(unittest.TestCase):
    """V2HarvestsActiveReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2HarvestsActiveReportGet200Response:
        """Test V2HarvestsActiveReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2HarvestsActiveReportGet200Response`
        """
        model = V2HarvestsActiveReportGet200Response()
        if include_optional:
            return V2HarvestsActiveReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["name__endswith:0003","name__contains:kush"],
                filter_logic = 'and',
                sort = 'label:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.metrc_harvest.MetrcHarvest(
                        id = 1234567, 
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        index = 'ACTIVE_HARVEST', 
                        facility_license_number = '1234567890', 
                        facility_name = 'Green Farms', 
                        name = 'WEDDINGCAKE010124', 
                        harvest_type = 'WholePlant', 
                        harvest_type_name = 'Harvest Batch', 
                        source_strain_count = 1, 
                        ...
                        total_waste_weight = 740.0, 
                        plant_count = 60, 
                        total_wet_weight = 81123.0, 
                        total_restored_weight = 0.0, 
                        package_count = 0, 
                        total_packaged_weight = 0.0, 
                        unit_of_weight_id = 4, 
                        unit_of_weight_abbreviation = 'g', 
                        lab_testing_state_name = 'NotSubmitted', 
                        lab_testing_state_date = '2024-07-26T20:00Z', 
                        is_on_hold = False, 
                        harvest_start_date = 'Wed Jul 17 19:00:00 CDT 2024', 
                        is_finished = False, 
    ...
    def testV2HarvestsActiveReportGet200Response(self):
        """Test V2HarvestsActiveReportGet200Response"""
