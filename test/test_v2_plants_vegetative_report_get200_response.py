...
class TestV2PlantsVegetativeReportGet200Response(unittest.TestCase):
    """V2PlantsVegetativeReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PlantsVegetativeReportGet200Response:
        """Test V2PlantsVegetativeReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PlantsVegetativeReportGet200Response`
        """
        model = V2PlantsVegetativeReportGet200Response()
        if include_optional:
            return V2PlantsVegetativeReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["label__endswith:0003","item.name__contains:kush"],
                filter_logic = 'and',
                sort = 'label:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.metrc_plant.MetrcPlant(
                        id = 123456, 
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        index = 'VEGETATIVE_PLANT', 
                        label = '1A4000000000000000312299', 
                        state_name = 'Tracked', 
                        growth_phase_name = 'Flowering', 
                        plant_count = 1, 
                        group_tag_type_max = 0, 
                        tag_type_max = 1, 
                        plant_batch_name = 'WEDDINGCAKE010124', 
    ...
    def testV2PlantsVegetativeReportGet200Response(self):
        """Test V2PlantsVegetativeReportGet200Response"""
