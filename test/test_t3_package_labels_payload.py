...
class TestT3PackageLabelsPayload(unittest.TestCase):
    """T3PackageLabelsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3PackageLabelsPayload:
        """Test T3PackageLabelsPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3PackageLabelsPayload`
        """
        model = T3PackageLabelsPayload()
        if include_optional:
            return T3PackageLabelsPayload(
    ...
    def testT3PackageLabelsPayload(self):
        """Test T3PackageLabelsPayload"""
