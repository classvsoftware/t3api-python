...
class TestV2PackagesTransferredGet200Response(unittest.TestCase):
    """V2PackagesTransferredGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesTransferredGet200Response:
        """Test V2PackagesTransferredGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesTransferredGet200Response`
        """
        model = V2PackagesTransferredGet200Response()
        if include_optional:
            return V2PackagesTransferredGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_delivery_package.MetrcDeliveryPackage(
                        ...
                        gross_unit_of_weight_abbreviation = 'g', 
                        gross_weight = 1.337, 
                        is_donation = False, 
                        ...
                        item_serving_size = '', 
                        item_strain_name = '', 
                        item_supply_duration_days = 1.337, 
                        item_unit_cbd_content = 1.337, 
                        item_unit_cbd_content_dose = 1.337, 
                        item_unit_cbd_content_dose_unit_of_measure_abbreviation = '', 
                        item_unit_cbd_content_unit_of_measure_abbreviation = '', 
                        item_unit_cbd_percent = 1.337, 
                        item_unit_quantity = 1.337, 
                        item_unit_quantity_unit_of_measure_abbreviation = '', 
                        item_unit_thc_content = 1.337, 
                        item_unit_thc_content_dose = 1.337, 
                        item_unit_thc_content_dose_unit_of_measure_abbreviation = '', 
                        item_unit_thc_content_unit_of_measure_abbreviation = '', 
                        item_unit_thc_percent = 1.337, 
                        item_unit_volume = 1.337, 
                        item_unit_volume_unit_of_measure_abbreviation = '', 
                        item_unit_weight = 1.337, 
                        item_unit_weight_unit_of_measure_abbreviation = 'g', 
                        lab_testing_state_name = 'TestPassed', 
                        multi_harvest = True, 
                        multi_package = False, 
                        package_id = 123456, 
                        package_label = '1A4000000000000000213809', 
                        package_type = 'Product', 
                        packaged_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        product_category_name = 'Infused-Edible', 
                        product_name = 'Mojo - Chocolate 20mg (Sativa)', 
                        product_requires_remediation = False, 
                        production_batch_number = '', 
                        received_quantity = 100, 
                        received_unit_of_measure_abbreviation = 'g', 
                        receiver_wholesale_price = 1.337, 
                        remediation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        shipment_package_state = 'Accepted', 
                        shipped_quantity = 50, 
                        shipped_unit_of_measure_abbreviation = 'g', 
                        shipper_wholesale_price = 1.337, 
                        source_harvest_names = 'HARVEST 1, HARVEST 2', 
                        source_package_is_donation = False, 
                        source_package_is_trade_sample = False, 
                        source_package_labels = '1A4000000000000000000528, 1A4000000000000000000529', 
                        ...
                        processing_job_type_id = 1.337, 
                        in_transit_status = 'InTransit', 
                        is_in_transit = True, 
                        expiration_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        retail_id_qr_count = 1.337, 
    ...
    def testV2PackagesTransferredGet200Response(self):
        """Test V2PackagesTransferredGet200Response"""
