...
class TestMetrcSessionAuthPayload(unittest.TestCase):
    """MetrcSessionAuthPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSessionAuthPayload:
        """Test MetrcSessionAuthPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSessionAuthPayload`
        """
        model = MetrcSessionAuthPayload()
        if include_optional:
            return MetrcSessionAuthPayload(
                username = 'johndoe',
                hostname = 'ca.metrc.com',
                cookies = {"metrc_session":"abc123xyz"},
                facilities = [
                    t3api.models.metrc_session_auth_payload_facilities_inner.MetrcSessionAuthPayload_facilities_inner(
                        facility_license_number = 'CML123456', 
                        facility_name = 'Green Leaf Dispensary', )
                    ],
                api_verification_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...'
            )
        else:
            return MetrcSessionAuthPayload(
                username = 'johndoe',
    ...
    def testMetrcSessionAuthPayload(self):
        """Test MetrcSessionAuthPayload"""
