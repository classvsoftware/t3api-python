...
class TestV2ItemsGet200Response(unittest.TestCase):
    """V2ItemsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsGet200Response:
        """Test V2ItemsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsGet200Response`
        """
        model = V2ItemsGet200Response()
        if include_optional:
            return V2ItemsGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2ItemsGet200Response(self):
        """Test V2ItemsGet200Response"""
