...
class TestPlantsApi(unittest.TestCase):
    ...
    def test_v2_plants_history_get(self) -> None:
        """Test case for v2_plants_history_get

        List of history objects for a single plant
        """
        pass

    def test_v2_plants_inactive_get(self) -> None:
        """Test case for v2_plants_inactive_get
    ...
    def test_v2_plants_vegetative_get(self) -> None:
        """Test case for v2_plants_vegetative_get
