...
class TestMetrcPackageReportResponse(unittest.TestCase):
    """MetrcPackageReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageReportResponse:
        """Test MetrcPackageReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageReportResponse`
        """
        model = MetrcPackageReportResponse()
        if include_optional:
            return MetrcPackageReportResponse(
    ...
    def testMetrcPackageReportResponse(self):
        """Test MetrcPackageReportResponse"""
