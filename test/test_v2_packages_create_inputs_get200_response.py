...
class TestV2PackagesCreateInputsGet200Response(unittest.TestCase):
    """V2PackagesCreateInputsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesCreateInputsGet200Response:
        """Test V2PackagesCreateInputsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesCreateInputsGet200Response`
        """
        model = V2PackagesCreateInputsGet200Response()
        if include_optional:
            return V2PackagesCreateInputsGet200Response(
                allowed_production_lab_testing_states = [
                    'TestPassed'
                    ],
                ...
                lab_test_batches = '',
                locations = [
                    t3api.models.metrc_location.MetrcLocation(
                        for_harvests = True, 
                        for_packages = True, 
                ...
                plants = '',
                remediation_methods = [
                    t3api.models.metrc_remediation_method.MetrcRemediationMethod(
                        id = 3, 
                        name = 'Repacking', )
                    ],
                submit_for_testing = False,
                tags = [
                    t3api.models.metrc_tag.MetrcTag(
                        id = 12345, 
                        ...
                        license_number = '', 
                        index = 'AVAILABLE_TAG', 
                        commissioned_date_time = '2022-01-19T07:00Z', 
                        detached_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        facility_id = 12345, 
                        group_tag_type_id = 'TagType-6', 
                        group_tag_type_name = 'Medical Package', 
                        is_archived = False, 
                        is_used = False, 
                        label = '1A4000000000000000000011', 
                        last_modified = '2023-08-29T01:00Z', 
                        max_group_size = 1, 
                        status_name = 'Received', 
                        tag_inventory_type_name = 'MedicalPackage', 
                        tag_type_id = 'TagType-6', 
                        tag_type_name = 'Medical Package', 
                        used_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
                    ],
                units_of_measure = [
    ...
    def testV2PackagesCreateInputsGet200Response(self):
        """Test V2PackagesCreateInputsGet200Response"""
