...
class TestMetrcHarvest(unittest.TestCase):
    """MetrcHarvest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvest:
        """Test MetrcHarvest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvest`
        """
        model = MetrcHarvest()
        if include_optional:
            return MetrcHarvest(
