...
class TestMetrcSuperpackageListResponse(unittest.TestCase):
    """MetrcSuperpackageListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSuperpackageListResponse:
        """Test MetrcSuperpackageListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSuperpackageListResponse`
        """
        model = MetrcSuperpackageListResponse()
        if include_optional:
            return MetrcSuperpackageListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcSuperpackageListResponse(self):
        """Test MetrcSuperpackageListResponse"""
