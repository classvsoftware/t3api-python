...
class TestExtractedLabResult(unittest.TestCase):
    """ExtractedLabResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtractedLabResult:
        """Test ExtractedLabResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtractedLabResult`
        """
    ...
    def testExtractedLabResult(self):
        """Test ExtractedLabResult"""
