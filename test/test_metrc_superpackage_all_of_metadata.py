...
class TestMetrcSuperpackageAllOfMetadata(unittest.TestCase):
    """MetrcSuperpackageAllOfMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSuperpackageAllOfMetadata:
        """Test MetrcSuperpackageAllOfMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSuperpackageAllOfMetadata`
        """
    ...
    def testMetrcSuperpackageAllOfMetadata(self):
        """Test MetrcSuperpackageAllOfMetadata"""
