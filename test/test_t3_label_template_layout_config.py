...
class TestT3LabelTemplateLayoutConfig(unittest.TestCase):
    """T3LabelTemplateLayoutConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelTemplateLayoutConfig:
        """Test T3LabelTemplateLayoutConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelTemplateLayoutConfig`
        """
        model = T3LabelTemplateLayoutConfig()
        if include_optional:
            return T3LabelTemplateLayoutConfig(
                name = '',
                description = '',
                pagesize_xin = 1.337,
                pagesize_yin = 1.337,
    ...
    def testT3LabelTemplateLayoutConfig(self):
        """Test T3LabelTemplateLayoutConfig"""
