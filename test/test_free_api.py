...
class TestFreeApi(unittest.TestCase):
    """FreeApi unit test stubs"""
    ...
    def test_v2_auth_credentials_post(self) -> None:
        """Test case for v2_auth_credentials_post

        Authenticate with Metrc credentials
        """
        pass

    def test_v2_auth_whoami_get(self) -> None:
        """Test case for v2_auth_whoami_get
    ...
    def test_v2_files_labels_generate_post(self) -> None:
        """Test case for v2_files_labels_generate_post

        Generate a PDF of labels.
        """
        pass

    def test_v2_files_labels_label_content_layouts_get(self) -> None:
        """Test case for v2_files_labels_label_content_layouts_get

        Returns a list of label content layouts
        """
        pass

    def test_v2_files_labels_label_template_layouts_get(self) -> None:
        """Test case for v2_files_labels_label_template_layouts_get
    ...
    def test_v2_licenses_get(self) -> None:
        """Test case for v2_licenses_get

        List of accessible licenses
        """
        pass

    def test_v2_permissions_get(self) -> None:
        """Test case for v2_permissions_get

        List of all permissions within a single view
        """
        pass

    def test_v2_permissions_views_get(self) -> None:
        """Test case for v2_permissions_views_get

        List of all available permission views
        """
        pass

    def test_v2_search_get(self) -> None:
        """Test case for v2_search_get

        Generic text search endpoint
        """
        pass

    def test_v2_states_get(self) -> None:
        """Test case for v2_states_get
