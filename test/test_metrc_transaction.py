...
class TestMetrcTransaction(unittest.TestCase):
    """MetrcTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransaction:
        """Test MetrcTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransaction`
        """
        model = MetrcTransaction()
        if include_optional:
            return MetrcTransaction(
                id = 123467,
