...
class TestV2LabelsGeneratePostRequest(unittest.TestCase):
    """V2LabelsGeneratePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2LabelsGeneratePostRequest:
        """Test V2LabelsGeneratePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2LabelsGeneratePostRequest`
        """
        model = V2LabelsGeneratePostRequest()
        if include_optional:
            return V2LabelsGeneratePostRequest(
    ...
    def testV2LabelsGeneratePostRequest(self):
        """Test V2LabelsGeneratePostRequest"""
