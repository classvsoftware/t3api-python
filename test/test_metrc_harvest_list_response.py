...
class TestMetrcHarvestListResponse(unittest.TestCase):
    """MetrcHarvestListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvestListResponse:
        """Test MetrcHarvestListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvestListResponse`
        """
        model = MetrcHarvestListResponse()
        if include_optional:
            return MetrcHarvestListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcHarvestListResponse(self):
        """Test MetrcHarvestListResponse"""
