...
class TestV2TransfersTemplatesCreatePostRequestInner(unittest.TestCase):
    """V2TransfersTemplatesCreatePostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersTemplatesCreatePostRequestInner:
        """Test V2TransfersTemplatesCreatePostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersTemplatesCreatePostRequestInner`
        """
        model = V2TransfersTemplatesCreatePostRequestInner()
        if include_optional:
            return V2TransfersTemplatesCreatePostRequestInner(
                name = 'My template',
                destinations = [
                    t3api.models._v2_transfers_templates_create_post_request_inner_destinations_inner._v2_transfers_templates_create_post_request_inner_destinations_inner(
                        recipient_id = 123456, 
                        ...
                        packages = [
                            t3api.models._v2_transfers_templates_create_post_request_inner_destinations_inner_packages_inner._v2_transfers_templates_create_post_request_inner_destinations_inner_packages_inner(
                                id = 123456, 
    ...
    def testV2TransfersTemplatesCreatePostRequestInner(self):
        """Test V2TransfersTemplatesCreatePostRequestInner"""
