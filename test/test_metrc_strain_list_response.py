...
class TestMetrcStrainListResponse(unittest.TestCase):
    """MetrcStrainListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcStrainListResponse:
        """Test MetrcStrainListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcStrainListResponse`
        """
        model = MetrcStrainListResponse()
        if include_optional:
            return MetrcStrainListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcStrainListResponse(self):
        """Test MetrcStrainListResponse"""
