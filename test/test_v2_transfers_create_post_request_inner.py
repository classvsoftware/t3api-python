...
class TestV2TransfersCreatePostRequestInner(unittest.TestCase):
    """V2TransfersCreatePostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreatePostRequestInner:
        """Test V2TransfersCreatePostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreatePostRequestInner`
        """
        model = V2TransfersCreatePostRequestInner()
        if include_optional:
    ...
    def testV2TransfersCreatePostRequestInner(self):
        """Test V2TransfersCreatePostRequestInner"""
