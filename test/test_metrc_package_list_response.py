...
class TestMetrcPackageListResponse(unittest.TestCase):
    """MetrcPackageListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPackageListResponse:
        """Test MetrcPackageListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPackageListResponse`
        """
        model = MetrcPackageListResponse()
        if include_optional:
            return MetrcPackageListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcPackageListResponse(self):
        """Test MetrcPackageListResponse"""
