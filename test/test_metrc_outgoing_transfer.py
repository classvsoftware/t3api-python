...
class TestMetrcOutgoingTransfer(unittest.TestCase):
    """MetrcOutgoingTransfer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcOutgoingTransfer:
        """Test MetrcOutgoingTransfer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcOutgoingTransfer`
        """
        model = MetrcOutgoingTransfer()
        if include_optional:
            return MetrcOutgoingTransfer(
    ...
    def testMetrcOutgoingTransfer(self):
        """Test MetrcOutgoingTransfer"""
