...
class TestMetrcTransferDelivery(unittest.TestCase):
    """MetrcTransferDelivery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcTransferDelivery:
        """Test MetrcTransferDelivery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcTransferDelivery`
        """
        model = MetrcTransferDelivery()
        if include_optional:
            return MetrcTransferDelivery(
                id = 12345,
    ...
    def testMetrcTransferDelivery(self):
        """Test MetrcTransferDelivery"""
