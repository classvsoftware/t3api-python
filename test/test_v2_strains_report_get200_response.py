...
class TestV2StrainsReportGet200Response(unittest.TestCase):
    """V2StrainsReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2StrainsReportGet200Response:
        """Test V2StrainsReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2StrainsReportGet200Response`
        """
        model = V2StrainsReportGet200Response()
        if include_optional:
            return V2StrainsReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["name__contains:kush"],
                filter_logic = 'and',
                sort = 'name:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.metrc_strain.MetrcStrain(
                        id = 12345, 
    ...
    def testV2StrainsReportGet200Response(self):
        """Test V2StrainsReportGet200Response"""
