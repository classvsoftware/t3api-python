...
class TestV2TransfersCreateDestinationsGet200Response(unittest.TestCase):
    """V2TransfersCreateDestinationsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreateDestinationsGet200Response:
        """Test V2TransfersCreateDestinationsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreateDestinationsGet200Response`
        """
        model = V2TransfersCreateDestinationsGet200Response()
        if include_optional:
            return V2TransfersCreateDestinationsGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_facility.MetrcFacility(
    ...
    def testV2TransfersCreateDestinationsGet200Response(self):
        """Test V2TransfersCreateDestinationsGet200Response"""
