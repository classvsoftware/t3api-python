...
class TestV2PlantbatchesActiveReportGet200Response(unittest.TestCase):
    """V2PlantbatchesActiveReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PlantbatchesActiveReportGet200Response:
        """Test V2PlantbatchesActiveReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PlantbatchesActiveReportGet200Response`
        """
        model = V2PlantbatchesActiveReportGet200Response()
        if include_optional:
            return V2PlantbatchesActiveReportGet200Response(
                generated_at = '2024-07-25T00:00Z',
                filters = ["name__endswith:0003","strainName__contains:kush"],
                filter_logic = 'and',
                sort = 'label:asc',
                license_number = 'LIC-00001',
                data = [
                    t3api.models.metrc_plant_batch.MetrcPlantBatch(
                        id = 123456, 
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        index = 'ACTIVE_PLANTBATCH', 
                        ...
                        source_plant_label = '1A4000000000000000013099', 
    ...
    def testV2PlantbatchesActiveReportGet200Response(self):
        """Test V2PlantbatchesActiveReportGet200Response"""
