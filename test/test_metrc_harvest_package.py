...
class TestMetrcHarvestPackage(unittest.TestCase):
    """MetrcHarvestPackage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvestPackage:
        """Test MetrcHarvestPackage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvestPackage`
        """
        model = MetrcHarvestPackage()
        if include_optional:
            return MetrcHarvestPackage(
                hostname = 'ca.metrc.com',
                data_model = 'MetrcPackage',
                retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                license_number = '',
                package_id = 123456,
                label = '1A40CCC00000000000004341',
                package_type = 'Product',
                product_name = 'Trimmed Popcorn | Sour Berry Gas',
                product_category_name = 'Bud/Flower',
                quantity = 13040.0,
                unit_of_measure_name = 'Grams',
                unit_of_measure_abbreviation = 'g',
                is_production_batch = True,
                production_batch_number = 'Trimmed Popcorn | Sour Berry Gas',
                actual_date = 'Mon Apr 14 19:00:00 CDT 2025',
                expiration_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                sell_by_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                use_by_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                is_archived = False,
                is_finished = False
            )
        else:
    ...
    def testMetrcHarvestPackage(self):
        """Test MetrcHarvestPackage"""
