...
class TestT3LabelContentLayoutConfig(unittest.TestCase):
    """T3LabelContentLayoutConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelContentLayoutConfig:
        """Test T3LabelContentLayoutConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelContentLayoutConfig`
        """
    ...
    def testT3LabelContentLayoutConfig(self):
        """Test T3LabelContentLayoutConfig"""
