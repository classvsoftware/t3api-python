...
class TestV2PackagesActiveGet200Response(unittest.TestCase):
    """V2PackagesActiveGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2PackagesActiveGet200Response:
        """Test V2PackagesActiveGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2PackagesActiveGet200Response`
        """
        model = V2PackagesActiveGet200Response()
        if include_optional:
            return V2PackagesActiveGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2PackagesActiveGet200Response(self):
        """Test V2PackagesActiveGet200Response"""
