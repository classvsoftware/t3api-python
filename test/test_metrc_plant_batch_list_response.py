...
class TestMetrcPlantBatchListResponse(unittest.TestCase):
    """MetrcPlantBatchListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPlantBatchListResponse:
        """Test MetrcPlantBatchListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPlantBatchListResponse`
        """
        model = MetrcPlantBatchListResponse()
        if include_optional:
            return MetrcPlantBatchListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcPlantBatchListResponse(self):
        """Test MetrcPlantBatchListResponse"""
