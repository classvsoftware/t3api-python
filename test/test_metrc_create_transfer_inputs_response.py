...
class TestMetrcCreateTransferInputsResponse(unittest.TestCase):
    """MetrcCreateTransferInputsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcCreateTransferInputsResponse:
        """Test MetrcCreateTransferInputsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcCreateTransferInputsResponse`
        """
        model = MetrcCreateTransferInputsResponse()
        if include_optional:
            return MetrcCreateTransferInputsResponse(
                adding = True,
                days_wholesale_price_can_edit = 0,
                default_phone_number_for_questions = '1231231234',
                destination_facilities = [
                    None
                    ],
                details = None,
                drivers = [
                    t3api.models.metrc_driver.MetrcDriver(
                        drivers_license_number = 'LIC-99991', 
                        employee_id = 'EMPL9991', 
                        facility_id = 12345, 
                        id = 12345, 
                        is_archived = False, 
                        last_modified = '2023-02-07T15:27:12Z', 
                        name = 'Joe Smith', )
                    ],
                edit_delivery_details_only = False,
                edit_wholesale_price_only = False,
                facilities = None,
                is_outgoing_inactive = False,
                items = None,
                packages = [
                    None
                    ],
                ...
                selected_transfer_template_ids = None,
                transfer_types = [
                    t3api.models._v2_transfers_create_inputs_get_200_response_transfer_types_inner._v2_transfers_create_inputs_get_200_response_transferTypes_inner(
                        facility_types = [
                            t3api.models._v2_transfers_create_inputs_get_200_response_transfer_types_inner_facility_types_inner._v2_transfers_create_inputs_get_200_response_transferTypes_inner_facilityTypes_inner(
                                facility_type_id = 1, 
                                facility_type_name = 'Medical Cultivation', )
                            ], 
                        for_external_incoming_shipments = False, 
                        for_external_outgoing_shipments = False, 
                        for_licensed_shipments = True, 
                        id = 1, 
                        max_discrepancy_percentage = 1.337, 
                        maximum_wholesale_price = 1.337, 
                        minimum_wholesale_price = 1.337, 
                        name = 'Affiliated Transfer', 
                        recipient_address_fields_enabled = True, 
                        recipient_license_name_field_enabled = True, 
                        recipient_license_number_field_enabled = True, 
                        recipient_license_number_field_label = 'License No.', 
                        requires_destination_gross_weight = False, 
                        requires_packages_gross_weight = True, 
                        shipper_address_fields_enabled = True, 
                        shipper_license_name_field_enabled = True, 
                        shipper_license_number_field_enabled = True, 
                        shipper_license_number_field_label = 'License No.', 
                        transaction_type = 'Standard', 
                        transaction_type_name = 'Standard', 
                        transporter_fields_enabled = True, )
                    ],
                transporter_facilities = [],
                units_of_measure = [
                    t3api.models.unit_of_measure.UnitOfMeasure(
                        abbreviation = 'ml', 
                        from_base_factor = 29.5735295625, 
                        id = 10, 
                        is_archived = False, 
                        is_base_unit = False, 
                        name = 'Milliliters', 
                        quantity_type = 'VolumeBased', 
                        to_base_factor = 0.033814022701843, )
                    ],
                vehicles = [
                    t3api.models.metrc_vehicle.MetrcVehicle(
                        facility_id = 17201, 
                        id = 32901, 
                        is_archived = False, 
                        last_modified = '2022-06-16T07:43:23-05:00', 
                        license_plate_number = 'LH7N4A', 
                        make = '2022 Ford 'Supersonic'', 
    ...
    def testMetrcCreateTransferInputsResponse(self):
        """Test MetrcCreateTransferInputsResponse"""
