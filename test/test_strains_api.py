...
class TestStrainsApi(unittest.TestCase):
    ...
    def test_v2_strains_create_post(self) -> None:
        """Test case for v2_strains_create_post

        Create one or more strains
        """
        pass

    def test_v2_strains_discontinue_post(self) -> None:
        """Test case for v2_strains_discontinue_post

        Discontinue one strain
        """
        pass

    def test_v2_strains_get(self) -> None:
        """Test case for v2_strains_get

        List of active strains
        """
        pass
