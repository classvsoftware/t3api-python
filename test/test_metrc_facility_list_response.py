...
class TestMetrcFacilityListResponse(unittest.TestCase):
    """MetrcFacilityListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcFacilityListResponse:
        """Test MetrcFacilityListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcFacilityListResponse`
        """
        model = MetrcFacilityListResponse()
        if include_optional:
            return MetrcFacilityListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcFacilityListResponse(self):
        """Test MetrcFacilityListResponse"""
