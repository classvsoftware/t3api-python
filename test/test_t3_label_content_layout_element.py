...
class TestT3LabelContentLayoutElement(unittest.TestCase):
    """T3LabelContentLayoutElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelContentLayoutElement:
        """Test T3LabelContentLayoutElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelContentLayoutElement`
        """
        model = T3LabelContentLayoutElement()
        if include_optional:
    ...
    def testT3LabelContentLayoutElement(self):
        """Test T3LabelContentLayoutElement"""
