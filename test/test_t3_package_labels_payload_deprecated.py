...
class TestT3PackageLabelsPayloadDEPRECATED(unittest.TestCase):
    """T3PackageLabelsPayloadDEPRECATED unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3PackageLabelsPayloadDEPRECATED:
        """Test T3PackageLabelsPayloadDEPRECATED
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3PackageLabelsPayloadDEPRECATED`
        """
        model = T3PackageLabelsPayloadDEPRECATED()
        if include_optional:
            return T3PackageLabelsPayloadDEPRECATED(
                label_template_layout_id = 'AVERY_8160__2_625Wx1_0H',
                label_content_layout_id = 'COL_TEXT_CODE128_TEXT',
                data = ["1A4000F8CDD6DCB30CA66725","1A4000455B81126C39BF2711","1A40007AE1592E6F22223385","1A40001820F953BF76585015","1A400014F8F91738716D2309","1A4000AF188D230BE3AF2306"],
                rendering_options = t3api.models._v2_files_labels_content_data_packages_active_post_request_rendering_options._v2_files_labels_content_data_packages_active_post_request_renderingOptions(
    ...
    def testT3PackageLabelsPayloadDEPRECATED(self):
        """Test T3PackageLabelsPayloadDEPRECATED"""
