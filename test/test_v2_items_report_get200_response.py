...
class TestV2ItemsReportGet200Response(unittest.TestCase):
    """V2ItemsReportGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsReportGet200Response:
        """Test V2ItemsReportGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsReportGet200Response`
        """
        model = V2ItemsReportGet200Response()
        if include_optional:
            return V2ItemsReportGet200Response(
                ...
                data = [
                    t3api.models.metrc_item.MetrcItem(
                        id = 12345, 
    ...
    def testV2ItemsReportGet200Response(self):
        """Test V2ItemsReportGet200Response"""
