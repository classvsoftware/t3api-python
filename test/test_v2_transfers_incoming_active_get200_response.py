...
class TestV2TransfersIncomingActiveGet200Response(unittest.TestCase):
    """V2TransfersIncomingActiveGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersIncomingActiveGet200Response:
        """Test V2TransfersIncomingActiveGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersIncomingActiveGet200Response`
        """
        model = V2TransfersIncomingActiveGet200Response()
        if include_optional:
            return V2TransfersIncomingActiveGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_incoming_transfer.MetrcIncomingTransfer(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        index = 'ACTIVE_INCOMING_TRANSFER', 
                        id = 1234567, 
    ...
    def testV2TransfersIncomingActiveGet200Response(self):
        """Test V2TransfersIncomingActiveGet200Response"""
