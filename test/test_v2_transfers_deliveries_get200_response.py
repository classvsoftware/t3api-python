...
class TestV2TransfersDeliveriesGet200Response(unittest.TestCase):
    """V2TransfersDeliveriesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersDeliveriesGet200Response:
        """Test V2TransfersDeliveriesGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersDeliveriesGet200Response`
        """
        model = V2TransfersDeliveriesGet200Response()
        if include_optional:
            return V2TransfersDeliveriesGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_transfer_delivery.MetrcTransferDelivery(
                        id = 12345, 
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        manifest_number = 1234567, 
                        delivery_number = 1234567, 
                        ...
                        delivery_received_package_count = 4, 
                        estimated_arrival_date_time = '2024-07-25T15:30Z', 
                        estimated_departure_date_time = '2024-07-25T13:30Z', 
                        ...
                        gross_unit_of_weight_abbreviation = 'kg', 
                        gross_unit_of_weight_id = 1, 
                        gross_weight = 100.5, 
                        ...
                        recipient_facility_license_number = 'AB12345', 
                        recipient_facility_name = 'Facility A', 
                        rejected_packages_returned = False, 
                        shipment_transaction_type_name = 'Regular', 
    ...
    def testV2TransfersDeliveriesGet200Response(self):
        """Test V2TransfersDeliveriesGet200Response"""
