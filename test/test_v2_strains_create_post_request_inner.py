...
class TestV2StrainsCreatePostRequestInner(unittest.TestCase):
    """V2StrainsCreatePostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2StrainsCreatePostRequestInner:
        """Test V2StrainsCreatePostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2StrainsCreatePostRequestInner`
        """
        model = V2StrainsCreatePostRequestInner()
        if include_optional:
            return V2StrainsCreatePostRequestInner(
                name = 'Blue Dream',
                cbd_level = 5,
                thc_level = 5,
                indica_percentage = 60.0,
                sativa_percentage = 40.0,
                testing_status = 'None'
            )
        else:
            return V2StrainsCreatePostRequestInner(
    ...
    def testV2StrainsCreatePostRequestInner(self):
        """Test V2StrainsCreatePostRequestInner"""
