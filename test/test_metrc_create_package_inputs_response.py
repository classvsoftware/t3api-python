...
class TestMetrcCreatePackageInputsResponse(unittest.TestCase):
    """MetrcCreatePackageInputsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcCreatePackageInputsResponse:
        """Test MetrcCreatePackageInputsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcCreatePackageInputsResponse`
        """
        model = MetrcCreatePackageInputsResponse()
        if include_optional:
            return MetrcCreatePackageInputsResponse(
    ...
    def testMetrcCreatePackageInputsResponse(self):
        """Test MetrcCreatePackageInputsResponse"""
