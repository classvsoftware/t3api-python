...
class TestMetrcSuperpackage(unittest.TestCase):
    """MetrcSuperpackage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcSuperpackage:
        """Test MetrcSuperpackage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcSuperpackage`
        """
        model = MetrcSuperpackage()
        if include_optional:
            return MetrcSuperpackage(
                id = 1234567,
                ...
                initial_lab_testing_state = 'TestPassed',
                is_archived = False,
                is_donation = False,
                ...
                lab_test_stage = '',
                external_id = 1.337,
                metadata = t3api.models.metrc_superpackage_all_of_metadata.MetrcSuperpackage_allOf_metadata(
                ...
                source_harvests = [
                    t3api.models.metrc_package_source_harvest.MetrcPackageSourceHarvest(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        harvested_by_facility_license_number = 'EX000001', 
                        harvested_by_facility_name = 'Example Facility LLC', 
                        name = '01012025 - Watermelon Gushers', 
                        harvest_type_name = 'Harvest Batch', 
                        lab_testing_state_name = 'Not Submitted', 
                        lab_testing_state_date = '', 
                        is_on_hold = True, 
                        harvest_start_date = 'Tue Dec 31 18:00:00 CST 2024', )
                    ],
                lab_results = [
                    t3api.models.metrc_package_lab_result.MetrcPackageLabResult(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        package_id = 123456, 
                        lab_test_result_id = 654321, 
                        lab_facility_license_number = 'TES000011', 
                        lab_facility_name = 'Green Precision Analytics Inc.', 
                        source_package_label = '1A4000000000000000025232', 
                        product_name = 'Wedding Cake Flower', 
                        product_category_name = 'Bud/Flower', 
                        test_performed_date = 'Sun Dec 31 18:00:00 CST 2023', 
                        overall_passed = True, 
                        is_revoked = False, 
                        revoked_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        lab_test_result_document_file_id = 123456, 
                        result_released = True, 
                        result_release_date_time = '2024-01-01T18:00Z', 
                        expiration_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        lab_test_detail_id = 4321234, 
                        test_type_name = 'Alpha-Bisabolol (%) Mandatory Terpenes', 
                        test_passed = True, 
                        test_result_level = 0.0234, 
                        test_comment = 'No significant findings.', 
                        test_informational_only = False, 
                        lab_test_detail_is_revoked = False, 
                        lab_test_detail_revoked_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        lab_test_result_last_modified = '2024-01-01T18:01Z', )
                    ],
                lab_result_batches = [
                    t3api.models.metrc_package_lab_result_batch.MetrcPackageLabResultBatch(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        id = 1234567, 
                        name = 'Additional - Mandatory Terpenes', 
                        test_types_required = 29, 
                        test_types_performed = 29, 
                        tests_passed = 58, 
                        tests_failed = 0, 
                        is_fully_revoked = True, 
                        tests = [
                            t3api.models.metrc_package_lab_result.MetrcPackageLabResult(
                                hostname = 'ca.metrc.com', 
                                data_model = 'MetrcPackage', 
                ...
                history = [
                    t3api.models.metrc_history.MetrcHistory(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcPackage', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        descriptions = ["Packaged 4,800 Grams of Wedding Cake Flower from 1 Harvest","- Took 4,800 Grams from Harvest \"240101WCAKE\"","- Package Type: Product","- Location: Drying Room","- Location Type: Default Location Type","- Production Batch No: WC0001"], 
                        user_name = 'Mary Smith (MSmith001)', 
                        actual_date = 'Sun Dec 31 18:00:00 CST 2023', 
                        recorded_date_time = '2024-01-01T13:07:00.719384Z', 
                        input_sources_names = 'User', 
    ...
    def testMetrcSuperpackage(self):
        """Test MetrcSuperpackage"""
