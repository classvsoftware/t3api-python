...
class TestMetrcHarvestPackageListResponse(unittest.TestCase):
    """MetrcHarvestPackageListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvestPackageListResponse:
        """Test MetrcHarvestPackageListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvestPackageListResponse`
        """
        model = MetrcHarvestPackageListResponse()
        if include_optional:
            return MetrcHarvestPackageListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_harvest_plant.MetrcHarvestPlant(
                        ...
                        plant_id = 234567, 
                        harvest_count = 1, 
                        label = '1A4000000000000000001655', 
                        location_name = 'Row 01', 
                        location_type_name = 'Default Location Type', 
                        patient_license_number = '', 
                        plant_batch_name = '01012025BLUEDREAM', 
                        plant_batch_type_name = 'Clone', 
                        harvest_specific_plant_count = 1, 
                        total_plant_count = 1, 
                        strain_name = 'Sour Berry Gas', 
                        is_on_hold = False, 
                        planted_date = 'Wed Nov 20 18:00:00 CST 2024', 
                        vegetative_date = 'Tue Dec 10 18:00:00 CST 2024', 
                        flowering_date = 'Thu Jan 23 18:00:00 CST 2025', 
                        destroyed_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        last_modified = '2025-03-28T17:42Z', )
                    ]
            )
        else:
            return MetrcHarvestPackageListResponse(
    ...
    def testMetrcHarvestPackageListResponse(self):
        """Test MetrcHarvestPackageListResponse"""
