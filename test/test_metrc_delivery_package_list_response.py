...
class TestMetrcDeliveryPackageListResponse(unittest.TestCase):
    """MetrcDeliveryPackageListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcDeliveryPackageListResponse:
        """Test MetrcDeliveryPackageListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcDeliveryPackageListResponse`
        """
        model = MetrcDeliveryPackageListResponse()
        if include_optional:
            return MetrcDeliveryPackageListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcDeliveryPackageListResponse(self):
        """Test MetrcDeliveryPackageListResponse"""
