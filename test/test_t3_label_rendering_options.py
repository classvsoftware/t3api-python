...
class TestT3LabelRenderingOptions(unittest.TestCase):
    """T3LabelRenderingOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> T3LabelRenderingOptions:
        """Test T3LabelRenderingOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `T3LabelRenderingOptions`
        """
        model = T3LabelRenderingOptions()
        if include_optional:
            return T3LabelRenderingOptions(
                debug = True,
    ...
    def testT3LabelRenderingOptions(self):
        """Test T3LabelRenderingOptions"""
