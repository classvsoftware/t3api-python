...
class TestMetrcPlantBatchReportResponse(unittest.TestCase):
    """MetrcPlantBatchReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPlantBatchReportResponse:
        """Test MetrcPlantBatchReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPlantBatchReportResponse`
        """
        model = MetrcPlantBatchReportResponse()
        if include_optional:
            return MetrcPlantBatchReportResponse(
    ...
    def testMetrcPlantBatchReportResponse(self):
        """Test MetrcPlantBatchReportResponse"""
