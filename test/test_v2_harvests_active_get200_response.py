...
class TestV2HarvestsActiveGet200Response(unittest.TestCase):
    """V2HarvestsActiveGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2HarvestsActiveGet200Response:
        """Test V2HarvestsActiveGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2HarvestsActiveGet200Response`
        """
        model = V2HarvestsActiveGet200Response()
        if include_optional:
            return V2HarvestsActiveGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testV2HarvestsActiveGet200Response(self):
        """Test V2HarvestsActiveGet200Response"""
