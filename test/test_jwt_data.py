...
class TestJWTData(unittest.TestCase):
    """JWTData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JWTData:
        """Test JWTData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JWTData`
        """
        model = JWTData()
        if include_optional:
            return JWTData(
