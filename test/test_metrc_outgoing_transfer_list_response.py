...
class TestMetrcOutgoingTransferListResponse(unittest.TestCase):
    """MetrcOutgoingTransferListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcOutgoingTransferListResponse:
        """Test MetrcOutgoingTransferListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcOutgoingTransferListResponse`
        """
        model = MetrcOutgoingTransferListResponse()
        if include_optional:
            return MetrcOutgoingTransferListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcOutgoingTransferListResponse(self):
        """Test MetrcOutgoingTransferListResponse"""
