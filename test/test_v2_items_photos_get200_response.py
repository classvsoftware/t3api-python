...
class TestV2ItemsPhotosGet200Response(unittest.TestCase):
    """V2ItemsPhotosGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ItemsPhotosGet200Response:
        """Test V2ItemsPhotosGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ItemsPhotosGet200Response`
        """
        model = V2ItemsPhotosGet200Response()
        if include_optional:
            return V2ItemsPhotosGet200Response(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
                data = [
                    t3api.models.metrc_item_photo.MetrcItemPhoto(
                        hostname = 'ca.metrc.com', 
                        data_model = 'MetrcItemPhoto', 
                        retrieved_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        license_number = '', 
                        file_name = 'Photos/Product photo-Cannabis Flower.png', 
                        product_id = 234567, 
                        image_file_id = 123456, 
                        file_type = 'ItemProductImage', )
                    ]
            )
        else:
            return V2ItemsPhotosGet200Response(
    ...
    def testV2ItemsPhotosGet200Response(self):
        """Test V2ItemsPhotosGet200Response"""
