...
class TestMetrcDeliveryPackage(unittest.TestCase):
    """MetrcDeliveryPackage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcDeliveryPackage:
        """Test MetrcDeliveryPackage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcDeliveryPackage`
        """
        model = MetrcDeliveryPackage()
        if include_optional:
            return MetrcDeliveryPackage(
    ...
    def testMetrcDeliveryPackage(self):
        """Test MetrcDeliveryPackage"""
