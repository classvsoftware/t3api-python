...
class TestMetrcPlantReportResponse(unittest.TestCase):
    """MetrcPlantReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPlantReportResponse:
        """Test MetrcPlantReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPlantReportResponse`
        """
        model = MetrcPlantReportResponse()
        if include_optional:
            return MetrcPlantReportResponse(
    ...
    def testMetrcPlantReportResponse(self):
        """Test MetrcPlantReportResponse"""
