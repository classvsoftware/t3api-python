...
class TestMetrcHarvestPlantListResponse(unittest.TestCase):
    """MetrcHarvestPlantListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcHarvestPlantListResponse:
        """Test MetrcHarvestPlantListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcHarvestPlantListResponse`
        """
        model = MetrcHarvestPlantListResponse()
        if include_optional:
            return MetrcHarvestPlantListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcHarvestPlantListResponse(self):
        """Test MetrcHarvestPlantListResponse"""
