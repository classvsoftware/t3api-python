...
class TestItemsApi(unittest.TestCase):
    ...
    def test_v2_items_discontinue_post(self) -> None:
        """Test case for v2_items_discontinue_post

        Discontinue one item
        """
        pass

    def test_v2_items_get(self) -> None:
        """Test case for v2_items_get

        List of active items
        """
        pass

    def test_v2_items_history_get(self) -> None:
        """Test case for v2_items_history_get
