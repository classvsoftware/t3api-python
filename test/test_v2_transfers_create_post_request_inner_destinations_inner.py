...
class TestV2TransfersCreatePostRequestInnerDestinationsInner(unittest.TestCase):
    """V2TransfersCreatePostRequestInnerDestinationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersCreatePostRequestInnerDestinationsInner:
        """Test V2TransfersCreatePostRequestInnerDestinationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersCreatePostRequestInnerDestinationsInner`
        """
        model = V2TransfersCreatePostRequestInnerDestinationsInner()
        if include_optional:
            return V2TransfersCreatePostRequestInnerDestinationsInner(
                recipient_id = 123456,
    ...
    def testV2TransfersCreatePostRequestInnerDestinationsInner(self):
        """Test V2TransfersCreatePostRequestInnerDestinationsInner"""
