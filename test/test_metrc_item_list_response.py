...
class TestMetrcItemListResponse(unittest.TestCase):
    """MetrcItemListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcItemListResponse:
        """Test MetrcItemListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcItemListResponse`
        """
        model = MetrcItemListResponse()
        if include_optional:
            return MetrcItemListResponse(
                page = 1,
                total_pages = 3,
                page_size = 100,
                total = 235,
    ...
    def testMetrcItemListResponse(self):
        """Test MetrcItemListResponse"""
