...
class TestMetrcPlantBatch(unittest.TestCase):
    """MetrcPlantBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetrcPlantBatch:
        """Test MetrcPlantBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetrcPlantBatch`
        """
        model = MetrcPlantBatch()
        if include_optional:
            return MetrcPlantBatch(
                id = 123456,
