...
class TestV2TransfersTemplatesCreatePostRequestInnerDestinationsInner(unittest.TestCase):
    """V2TransfersTemplatesCreatePostRequestInnerDestinationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TransfersTemplatesCreatePostRequestInnerDestinationsInner:
        """Test V2TransfersTemplatesCreatePostRequestInnerDestinationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TransfersTemplatesCreatePostRequestInnerDestinationsInner`
        """
        model = V2TransfersTemplatesCreatePostRequestInnerDestinationsInner()
        if include_optional:
            return V2TransfersTemplatesCreatePostRequestInnerDestinationsInner(
                recipient_id = 123456,
    ...
    def testV2TransfersTemplatesCreatePostRequestInnerDestinationsInner(self):
        """Test V2TransfersTemplatesCreatePostRequestInnerDestinationsInner"""
