...
class V2TransfersCreatePostRequestInnerDestinationsInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "packages": [V2TransfersCreatePostRequestInnerDestinationsInnerPackagesInner.from_dict(_item) for _item in obj["packages"]] if obj.get("packages") is not None else None
        })
        return _obj
