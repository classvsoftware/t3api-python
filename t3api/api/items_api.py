...
class ItemsApi:
    ...
    def v2_items_discontinue_post(
        ...
        :param v2_items_discontinue_post_request: (required)
        :type v2_items_discontinue_post_request: V2ItemsDiscontinuePostRequest
        ...
        _param = self._v2_items_discontinue_post_serialize(
            license_number=license_number,
            v2_items_discontinue_post_request=v2_items_discontinue_post_request,
            submit=submit,
    ...
    @validate_call
    def v2_items_discontinue_post_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_items_discontinue_post_request: V2ItemsDiscontinuePostRequest,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    @validate_call
    def v2_items_discontinue_post_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_items_discontinue_post_request: V2ItemsDiscontinuePostRequest,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    def _v2_items_discontinue_post_serialize(
        self,
        license_number,
        v2_items_discontinue_post_request,
        submit,
        _request_auth,
        _content_type,
        _headers,
        ...
        if v2_items_discontinue_post_request is not None:
            _body_params = v2_items_discontinue_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/items/discontinue',
    ...
    def v2_items_get(
        ...
        _param = self._v2_items_get_serialize(
            license_number=license_number,
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def v2_items_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    @validate_call
    def v2_items_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    def v2_items_history_get(
        ...
        _param = self._v2_items_history_get_serialize(
            license_number=license_number,
            item_id=item_id,
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def v2_items_history_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        item_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target item")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
    ...
    @validate_call
    def v2_items_history_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        item_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target item")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
    ...
    def _v2_items_history_get_serialize(
        self,
        license_number,
        item_id,
        page,
