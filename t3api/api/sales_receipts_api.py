...
class SalesReceiptsApi:
    ...
    def v2_sales_active_get(
        ...
        _param = self._v2_sales_active_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V2SalesActiveGet200Response",
        }
    ...
    @validate_call
    def v2_sales_active_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V2SalesActiveGet200Response]:
        """List of active sales
    ...
    @validate_call
    def v2_sales_active_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    def _v2_sales_active_get_serialize(
        self,
        license_number,
        page,
        page_size,
    ...
    def v2_sales_inactive_get(
        ...
        _param = self._v2_sales_inactive_get_serialize(
            license_number=license_number,
            page=page,
            page_size=page_size,
            strict_pagination=strict_pagination,
    ...
    @validate_call
    def v2_sales_inactive_get_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    @validate_call
    def v2_sales_inactive_get_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        page: Annotated[Optional[StrictInt], Field(description="The index of the page to be returned.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of objects per page to be returned.")] = None,
    ...
    def _v2_sales_inactive_get_serialize(
        self,
        license_number,
        page,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/sales/inactive',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v2_sales_transactions_get(
        ...
        :param sales_receipt_id: ID of the target sales receipt (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V2SalesTransactionsGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def v2_sales_transactions_get_with_http_info(
        self,
        sales_receipt_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target sales receipt")],
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        include_history: Annotated[Optional[StrictBool], Field(description="Enables access to archived transactions in Metrc")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V2SalesTransactionsGet200Response]:
        """List of transactions for a single sales receipt
    ...
    @validate_call
    def v2_sales_transactions_get_without_preload_content(
        self,
        sales_receipt_id: Annotated[Union[StrictFloat, StrictInt], Field(description="ID of the target sales receipt")],
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        include_history: Annotated[Optional[StrictBool], Field(description="Enables access to archived transactions in Metrc")] = None,
    ...
    def _v2_sales_transactions_get_serialize(
        self,
        sales_receipt_id,
        license_number,
        include_history,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/sales/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v2_sales_unfinalize_post(
        ...
        :param license_number: The unique identifier for the license associated with this request. (required)
        :type license_number: str
        :param v2_sales_unfinalize_post_request_inner: (required)
        :type v2_sales_unfinalize_post_request_inner: List[V2SalesUnfinalizePostRequestInner]
        ...
        _param = self._v2_sales_unfinalize_post_serialize(
            license_number=license_number,
            v2_sales_unfinalize_post_request_inner=v2_sales_unfinalize_post_request_inner,
            submit=submit,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def v2_sales_unfinalize_post_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_sales_unfinalize_post_request_inner: List[V2SalesUnfinalizePostRequestInner],
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    @validate_call
    def v2_sales_unfinalize_post_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_sales_unfinalize_post_request_inner: List[V2SalesUnfinalizePostRequestInner],
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    def _v2_sales_unfinalize_post_serialize(
        self,
        license_number,
        v2_sales_unfinalize_post_request_inner,
        submit,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if v2_sales_unfinalize_post_request_inner is not None:
            _body_params = v2_sales_unfinalize_post_request_inner
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/sales/unfinalize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v2_sales_void_post(
        ...
        :type license_number: str
        :param v2_sales_unfinalize_post_request_inner: (required)
        :type v2_sales_unfinalize_post_request_inner: V2SalesUnfinalizePostRequestInner
        :param submit: Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run 
        :type submit: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._v2_sales_void_post_serialize(
            license_number=license_number,
            v2_sales_unfinalize_post_request_inner=v2_sales_unfinalize_post_request_inner,
            submit=submit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def v2_sales_void_post_with_http_info(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_sales_unfinalize_post_request_inner: V2SalesUnfinalizePostRequestInner,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    @validate_call
    def v2_sales_void_post_without_preload_content(
        self,
        license_number: Annotated[StrictStr, Field(description="The unique identifier for the license associated with this request.")],
        v2_sales_unfinalize_post_request_inner: V2SalesUnfinalizePostRequestInner,
        submit: Annotated[Optional[StrictStr], Field(description="Controls whether this request should be forwarded to Metrc. - **If present and set to 'true'**: The request will be validated and forwarded to Metrc if validation passes. - **If omitted or set to any value other than 'true'**: The request will only be validated. Examples:   - \"true\": Forward the request to Metrc   - \"false\": Execute a dry run ")] = None,
    ...
    def _v2_sales_void_post_serialize(
        self,
        license_number,
        v2_sales_unfinalize_post_request_inner,
        submit,
