...
------------- | ------------- | -------------
[**v2_harvests_plants_get**](PlantsApi.md#v2_harvests_plants_get) | **GET** /v2/harvests/plants | List of harvest plant objects for a single harvest.
...
[**v2_plants_onhold_get**](PlantsApi.md#v2_plants_onhold_get) | **GET** /v2/plants/onhold | 
...
with t3api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PlantsApi->v2_harvests_plants_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PlantsApi->v2_harvests_plants_get: %s\n" % e)
```
