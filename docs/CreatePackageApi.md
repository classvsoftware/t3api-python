# t3api.CreatePackageApi

All URIs are relative to *https://api.trackandtrace.tools*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v2_packages_create_inputs_get**](CreatePackageApi.md#v2_packages_create_inputs_get) | **GET** /v2/packages/create/inputs | Input data used for creating new packages
[**v2_packages_create_post**](CreatePackageApi.md#v2_packages_create_post) | **POST** /v2/packages/create | Create one or more packages from existing active packages
[**v2_packages_create_source_items_get**](CreatePackageApi.md#v2_packages_create_source_items_get) | **GET** /v2/packages/create/source-items | List of items eligible to be used in creating new packages
[**v2_packages_create_source_packages_get**](CreatePackageApi.md#v2_packages_create_source_packages_get) | **GET** /v2/packages/create/source-packages | List of packages eligible to be used in creating new packages
...
with t3api.ApiClient(configuration) as api_client:
    ...
    api_instance = t3api.CreatePackageApi(api_client)
    ...
    try:
        ...
        print("The response of CreatePackageApi->v2_packages_create_inputs_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreatePackageApi->v2_packages_create_inputs_get: %s\n" % e)
```
...
with t3api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CreatePackageApi->v2_packages_create_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreatePackageApi->v2_packages_create_post: %s\n" % e)
```
...
with t3api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CreatePackageApi->v2_packages_create_source_items_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreatePackageApi->v2_packages_create_source_items_get: %s\n" % e)
```
...
with t3api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CreatePackageApi->v2_packages_create_source_packages_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreatePackageApi->v2_packages_create_source_packages_get: %s\n" % e)
```
